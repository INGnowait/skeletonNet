...
class ske_Evaluator(DatasetEvaluator):
    ...
    def __init__(self, cfg, dataset_name, distributed, output_dir, train_objs=None):
        ...
        if "air" in dataset_name:
            ...
            for model_path in self.model_paths:
                ...
                model['pts']=np.array(model['pts'])*vertex_scale  # 单位转为m
...
def ske_inference_on_dataset(cfg, model, data_loader, evaluator, amp_test=False):
